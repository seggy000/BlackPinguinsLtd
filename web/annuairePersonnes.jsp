    ...
    <body>
        ...
        <script>
            ...
            $('.modal-confirm-delete').on('click', function () {
                ...
                $('body').removeClass();
                $('#confirm-delete').find('.btn-ok').attr('href', $(this).attr('data-href'));
                $('#confirm-delete').find('#confirm-delete-customer').text($(this).attr('data-firstname') + ' ' + $(this).attr('data-lastname'));
                $('#confirm-delete').find('#confirm-delete-customer').attr('title', 'Adresse: ' + $(this).attr('data-address') + ', ' + 'Ville: ' + $(this).attr('data-city'));
            });
            $('.modal-customer-preview').on('click', function () {
                $('#customer-preview').modal('show');
                $('.modal-backdrop').appendTo('#main-container');
                $('body').removeClass();
                $('#customer-preview').find('#customer-preview-firstname').text($(this).attr('data-firstname'));
                $('#customer-preview').find('#customer-preview-lastname').text($(this).attr('data-lastname'));
                $('#customer-preview').find('#customer-preview-address').text($(this).attr('data-address'));
                $('#customer-preview').find('#customer-preview-city').text($(this).attr('data-city'));
                $('#customer-preview').find('.btn-edit').attr('href', 'modificationPersonne.jsp?id=' + $(this).attr('data-id'));
                $('#customer-preview').find('.btn-delete').attr('data-href', 'ServletFaireEffacementPersonne?id=' + $(this).attr('data-id'));
                $('#customer-preview').find('.btn-delete').attr('data-firstname', $(this).attr('data-firstname'));
                $('#customer-preview').find('.btn-delete').attr('data-lastname', $(this).attr('data-lastname'));
                $('#customer-preview').find('.btn-delete').attr('data-address', $(this).attr('data-address'));
                $('#customer-preview').find('.btn-delete').attr('data-city', $(this).attr('data-city'));
