    ...
    <body>
                        ...
                        <div class="col-lg-offset-4 col-lg-4">
                            <div class="block">
                                ...
                                <div class="block-content block-content-narrow">
                                    <form class="form-horizontal push-10-t" id="create-form" action="ServletCreationPersonne" method="post">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <label for="firstname">Pr&eacute;nom <span class="text-danger">*</span></label>
                                                <input class="form-control" type="text" id="firstname" name="firstname" placeholder="Pr&eacute;nom du client..." required="true">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <label for="lastname">Nom <span class="text-danger">*</span></label>
                                                <input class="form-control" type="text" id="lastname" name="lastname" placeholder="Nom du client..." required="true">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <label for="address">Adresse <span class="text-danger">*</span></label>
                                                <input class="form-control" type="text" id="address" name="address" placeholder="Adresse du client..." required="true">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <label for="city">Ville <span class="text-danger">*</span></label>
                                                <input class="form-control" type="text" id="city" name="city" placeholder="Ville du client..." required="true">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
        ...
        <script>
            $('#create-form').submit(function () {
                ...
                $('body').removeClass();
                $('#waiting-modal').find('.modal-title').append('Ajout en cours...');
            });
